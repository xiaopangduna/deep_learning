...
function export_ovx_network()
{
    ...
    mv_cmd="mv ${generate_path}_nbg_unify/network_binary.nb ${generate_path}_nbg_unify/${NAME}_${QUANTIZED}_${PLATFORM_NAME}.nb"
    eval $mv_cmd
    echo " =========== End rename network_binary.nb to ${NAME}_${QUANTIZED}_${PLATFORM_NAME}.nb ==========="
    
    cp_cmd="cp ${generate_path}_nbg_unify/${NAME}_${QUANTIZED}_${PLATFORM_NAME}.nb ../model/"
    eval $cp_cmd
    echo " =========== copy ${NAME}_${QUANTIZED}_${PLATFORM_NAME}.nb to ../model/ ==========="
...
if [ "$#" -lt 3 ]; then
    ...
    echo "Usage: pegasus_export_ovx_nbg.sh <model_name> <quantize_type> <platform>"
