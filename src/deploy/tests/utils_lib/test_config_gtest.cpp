...
TEST(YamlConfigTest, LoadConfig) {
    ...
    // 假设存在一个测试用的 YAML 文件
    bool result = yamlConfig.load("/home/xiaopangdun/project/deep_learning/src/deploy/tests/utils_lib/test_json.json");
...
TEST(YamlConfigTest, GetValue) {
    YamlConfig yamlConfig;
    if (yamlConfig.load("/home/xiaopangdun/project/deep_learning/src/deploy/tests/utils_lib/test_json.json")) {
